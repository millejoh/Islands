...
def setup_protos(lib):
    ...
    lib.TCOD_heightmap_dig_bezier.argtypes = [c_void_p, POINTER(c_int), POINTER(c_int), c_float, c_float, c_float,
                                              c_float]
    ...
    lib.TCOD_heightmap_kernel_transform.argtypes = [c_void_p, c_int, POINTER(c_int), POINTER(c_int), POINTER(c_float),
                                                    c_float, c_float]
    ...
    lib.TCOD_heightmap_add_fbm.argtypes = [c_void_p, c_int, c_float, c_float, c_float, c_float, c_float, c_float,
                                           c_float]

    lib.TCOD_heightmap_scale_fbm.restype = c_void
    lib.TCOD_heightmap_scale_fbm.argtypes = [c_void_p, c_int, c_float, c_float, c_float, c_float, c_float, c_float,
                                             c_float]
