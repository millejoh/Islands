...
default_font = os.path.join(os.path.dirname(os.path.abspath(__file__)), os.path.normpath('data/fonts/terminal8x8_gs_tc.png'))
root_console = 0
...
class RootConsole(Thread, Console):
    ...
    def __init__(self, width=80, height=50, title=b'Stage',
                 ...
                 font_file=default_font, font_flags=tcod.FONT_LAYOUT_TCOD | tcod.FONT_TYPE_GREYSCALE,
